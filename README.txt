...
Like most games played using hands, it uses different gestures of the hand do denote different
number of runs. For more see the "How to Play" section.

This is an interactive console variant of the game, made for both Turbo C++ and ANSI C++
This project is initiated as an end year compulsory CS project, by 11th class students (see "Authors")
...
This game, including all its components, can be reused and modified under the terms of MIT LICENSE.
